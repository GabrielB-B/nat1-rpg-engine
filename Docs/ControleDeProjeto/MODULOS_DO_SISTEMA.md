...
| Security Baseline | Concluída e integrada — G0 | Validar isolamento, configuração, dependências, PostgreSQL e CI. | Auth, API, frontend, Alembic e PostgreSQL. | Baseline integrada pela PR #13, com CI e auditorias aprovados. | Manter atualização de dependências e auditorias obrigatórias no CI. |
